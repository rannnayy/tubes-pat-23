...
func (hp params) Hash(password string) (encodedHash string, err error) {
	salt, err := generateRandomBytes(hp.saltLength)
	if err != nil {
		return "", err
	}
...
func (hp params) Verify(password, encodedHash string) (match bool, err error) {
